...
<%
	...
	BoardVO rec = service.getArticleById(id);
...
<title>게시글 수정하기</title>
 ...
 <body>
	<h4> 게시판 글 수정하기 </h4><br/>
	<form name='frm' method='post' action='BoardModify.jsp?seq=<%=rec.getSeq() %>'>
	제  목 : <input type='text' name='title' value='<%=rec.getTitle()%>'><br/><br/>
	패스워드(수정/삭제시 필요) :
			<input type='password' name='pass'><br/><br/>
	내  용 : <textarea name='content' rows='10' cols='40'><%=rec.getContent() %></textarea><br/>
	<br/>
