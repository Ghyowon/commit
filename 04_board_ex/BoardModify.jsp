...
<jsp:setProperty name='rec' property='title'></jsp:setProperty>
<jsp:setProperty name='rec' property='pass'></jsp:setProperty>
<jsp:setProperty name='rec' property='content'></jsp:setProperty>
</jsp:useBean>
